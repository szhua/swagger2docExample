...
public class GenerateDocTest {
    ...
    private String urlPath ="http://localhost:8091/v2/api-docs" ;
    ...
    public void generateAsciiDocs() throws Exception {
        ...
        Swagger2MarkupConverter.from(new URL(urlPath))
                .withConfig(config)
                .build()
                .toFolder(Paths.get("src/docs/asciidoc/generated"));//设置生成文件的路径
    }
